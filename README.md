# nvim-treesitter-queries-templ

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-templ/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-templ/actions/workflows/validate.yml)

Neovim tree-sitter queries for **templ**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-templ",
...
- [ ] Changes are scoped to `templ` — do not include files for other languages
